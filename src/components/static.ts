...
export const initialChartTypes = [
  { name: "Info", show: true },
  { name: "Line: ms", show: true },
  { name: "Line: FPS", show: false },
  { name: "Scatter: ms (very slow)", show: false },
  { name: "Scatter: FPS (very slow)", show: false },
...
export const barMetrics = [
  { name: "Max", color: "rgb(0,70,0)" },
  { name: "Avg", color: "rgb(0,140,0)" },
  { name: "Min", color: "rgb(0,210,0)" },
